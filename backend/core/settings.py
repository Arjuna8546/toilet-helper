...
# Celery / Redis. Set CELERY_BROKER_URL in the production environment to the
# private Redis endpoint (for example redis://:password@host:6379/0).
...
LOGGING = {
    ...
    "loggers": {
        "toilet_agents": {          # ← catches all toilet_agents.* loggers
            "handlers": ["console"],
            "level":    "DEBUG",
            "propagate": False,
        },
